//********************************************************************************************************************************
//*                                                                                                                              *
//*     ID3v1 Library 2.0.28.70 © 3delite 2010-2014                                                                              *
...
begin
    ...
    Bytes := ANSIEncoding.GetBytes(Source);
...
begin
    ...
    then begin
        ...
        TagStream.Seek(- (128 + 9 + 6 + TagSize), soEnd);
    ...
    try
        ...
        for i := 0 to Length(LyricsFrames) - 1 do begin
            ...
            if LyricsFrames[i].ID = 'EAL' then begin
                SetLength(Bytes, 0);
                Bytes := UTF8Encoding.GetBytes(Album);
            ...
            if LyricsFrames[i].ID = 'EAR' then begin
                SetLength(Bytes, 0);
                Bytes := UTF8Encoding.GetBytes(Artist);
                LyricsFieldSize := NumberToFieldSize(Length(Bytes));
                TagSize := TagSize + TagStream.Write(LyricsFieldSize, 5);
                TagSize := TagSize + TagStream.Write(Bytes[0], Length(Bytes));
                Continue;
            ...
            if LyricsFrames[i].ID = 'ETT' then begin
                SetLength(Bytes, 0);
                Bytes := UTF8Encoding.GetBytes(Title);
                LyricsFieldSize := NumberToFieldSize(Length(Bytes));
                TagSize := TagSize + TagStream.Write(LyricsFieldSize, 5);
                TagSize := TagSize + TagStream.Write(Bytes[0], Length(Bytes));
                Continue;
            ...
            SetLength(Bytes, 0);
            Bytes := UTF8Encoding.GetBytes(LyricsFrames[i].Data);
            LyricsFieldSize := NumberToFieldSize(Length(Bytes));
            TagSize := TagSize + TagStream.Write(LyricsFieldSize, 5);
            TagSize := TagSize + TagStream.Write(Bytes[0], Length(Bytes));
        end;
