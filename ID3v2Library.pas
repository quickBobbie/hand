//********************************************************************************************************************************
//*                                                                                                                              *
//*     ID3v2 Library 2.0.28.70 © 3delite 2010-2014                                                                              *
...
//*                                                                                                                              *
//* and also a WAV Tag Library available at:                                                                                     *
//*                                                                                                                              *
...
Const
    ...
    function GetID3v2Size(PMemory: Pointer): Cardinal;
        ...
        case Data of
            ...
            3: begin
                ...
                if ReturnNativeText then begin
                    Result := ANSIEncoding.GetString(Bytes);
                end else begin
...
begin
    ...
    Bytes := UTF8Encoding.GetBytes(Text);
    try
        Frames[FrameIndex].Stream.Clear;
        Data := $03;
        Frames[FrameIndex].Stream.Write(Data, 1);
...
begin
    ...
    try
        ...
        //* Set the description
        Bytes := ANSIEncoding.GetBytes(Description);
        Frames[FrameIndex].Stream.Write(Bytes[0], Length(Bytes));
        Data := $00;
        Frames[FrameIndex].Stream.Write(Data, 1);
        //* Write the content with
        SetLength(Bytes, 0);
        Bytes := ANSIEncoding.GetBytes(Content);
        Frames[FrameIndex].Stream.Write(Bytes[0], Length(Bytes));
        Data := $00;
        Frames[FrameIndex].Stream.Write(Data, 1);
        Frames[FrameIndex].Stream.Seek(0, soFromBeginning);
...
begin
    ...
    try
        ...
        Frames[FrameIndex].Stream.Write(Data, 1);
        //* Set the MIME type
        Bytes := ANSIEncoding.GetBytes(MIMEType);
        Frames[FrameIndex].Stream.Write(Bytes[0], Length(Bytes));
        Data := $00;
        Frames[FrameIndex].Stream.Write(Data, 1);
        ///* Set picture type
...
begin
    ...
    try
        ...
        //* Write the URL
        SetLength(Bytes, 0);
        Bytes := UTF8Encoding.GetBytes(URL);
        Frames[FrameIndex].Stream.Write(Bytes[0], Length(Bytes));
        Data := $00;
        Frames[FrameIndex].Stream.Write(Data, 1);
        Frames[FrameIndex].Stream.Seek(0, soFromBeginning);
        ...
        case Data of
            ...
            3: begin
                ...
                repeat
                    ...
                    Inc(ByteCounter);
                until Frames[FrameIndex].Stream.Position >= Frames[FrameIndex].Stream.Size;
                TDRCDateTime := UTF8Encoding.GetString(Bytes);
            end;
            else begin
                Frames[FrameIndex].Stream.Seek(0, soBeginning);
                repeat
...
begin
    ...
    try
        ...
        Bytes := ANSIEncoding.GetBytes(TDRCDateTime);
        Data := 0;
        Frames[FrameIndex].Stream.Write(Data, 1);
        //* Set the date time
        Frames[FrameIndex].Stream.Write(Bytes[0], Length(Bytes));
        ...
        case EncodingFormat of
            ...
            3: begin
                repeat
                    ...
                    until (Data = 0)
                    OR (Frames[FrameIndex].Stream.Position >= Frames[FrameIndex].Stream.Size);
                    Name := UTF8Encoding.GetString(Bytes);
                    SetLength(Bytes, 0);
                    ByteCounter := 0;
                    repeat
                        Frames[FrameIndex].Stream.Read(Data, 1);
                    ...
                    until (Data = 0)
                    OR (Frames[FrameIndex].Stream.Position >= Frames[FrameIndex].Stream.Size);
                    Value := UTF8Encoding.GetString(Bytes);
                    List.Append(Name + '=' + Value);
                    Result := True;
                until (Frames[FrameIndex].Stream.Position >= Frames[FrameIndex].Stream.Size);
            end;
